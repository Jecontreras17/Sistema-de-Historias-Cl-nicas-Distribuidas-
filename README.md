# Sistema-de-Historias-Cl-nicas-Distribuidas-
...
##### Evita errores al instalar herramientas nuevas y mejora la seguridad del sistema.
```
sudo apt update && sudo apt upgrade-y
```
### 2. Instalar utilidades y herramientas de desarrollo.
##### Son las herramientas básicas para desarrollar y ejecutar el proyecto.
```
...
##### Permite comprobar que los programas que se instalan son oficiales y no modificados.
```
sudo install -m 0755 -d /etc/apt/keyrings
```
### 4. Importar clave GPG de Docker.
Sin esta clave, el sistema no permite instalar Docker por seguridad.
```
